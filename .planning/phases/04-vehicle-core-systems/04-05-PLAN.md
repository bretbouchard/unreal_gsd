...
2. Create GSDVehicleSpawnerSubsystem.h:
   ...
   Declare delegate for async spawn completion:
   ...
   GetSpawnedVehicles:
   - Parameters: none
   - Returns: const TArray&lt;AGSDVehiclePawn*&gt;&
   - Category: "GSD|Vehicles"
   - BlueprintPure

   Protected members:
   - UPROPERTY() TArray&lt;AGSDVehiclePawn*&gt; SpawnedVehicles
...
3. Implement SpawnVehicle:
   ...
   - Call Vehicle->SpawnAsync(Config) to apply configuration
...
4. Implement SpawnVehicleAsync:
   ...
   - Spawn the vehicle
   - Call SpawnAsync on the vehicle
...
grep "SpawnAsync" Plugins/GSD_Vehicles/Source/GSD_Vehicles/Private/Subsystems/GSDVehicleSpawnerSubsystem.cpp
