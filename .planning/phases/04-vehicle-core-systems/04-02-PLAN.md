...
2. Create GSDWheelConfig.h with properties:
   ...
   - UCLASS(BlueprintType)  // Note: UCLASS doesn't support Category, use in UPROPERTY instead
...
1. Create GSDVehicleConfig.h with properties:
   ...
   Engine:
   - TorqueCurve: TObjectPtr&lt;UCurveFloat&gt; - engine torque vs RPM (Council: Use TObjectPtr for UE5.4+ compatibility)
