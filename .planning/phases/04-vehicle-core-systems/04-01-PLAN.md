...
must_haves:
  ...
  key_links:
    - from: "GSD_Vehicles.Build.cs"
      ...
      pattern: "GSD_Core"
    - from: "GSD_Vehicles.Build.cs"
      to: "GSD_CityStreaming module"
      via: "PublicDependencyModuleNames"
      pattern: "GSD_CityStreaming"
    - from: "GSD_Vehicles.Build.cs"
      to: "ChaosVehicles"
...
2. Create GSD_Vehicles.Build.cs with dependencies:
   PublicDependencyModuleNames: Core, CoreUObject, Engine, InputCore, GSD_Core, GSD_CityStreaming, DeveloperSettings
   ...
   CRITICAL (Council): Include GSD_CityStreaming for UGSDStreamingSourceComponent integration.
   CRITICAL (Council): Include DeveloperSettings for UGSDCityStreamingSettings pattern.
