...
files_modified:
  ...
  - Plugins/GSD_DailyEvents/Source/GSD_DailyEvents/Private/Tags/GSDEventTags.cpp
...
must_haves:
  ...
  artifacts:
    - path: "Plugins/GSD_DailyEvents/Source/GSD_DailyEvents/Public/Tags/GSDEventTags.h"
      ...
      min_lines: 50
    - path: "Plugins/GSD_DailyEvents/Source/GSD_DailyEvents/Private/Tags/GSDEventTags.cpp"
      provides: "Tag constant initialization"
      contains: "RequestGameplayTag"
      contains: "Event.Daily"
      min_lines: 30
...
<task type="auto">
  ...
  <action>
    ...
    3. Create Tags/ directory under Private/

    4. Create GSDEventTags.cpp with tag initialization:
  ...
  <verify>
    ...
    grep -l "RequestGameplayTag" Plugins/GSD_DailyEvents/Source/GSD_DailyEvents/Private/Tags/GSDEventTags.cpp
  </verify>
  <done>
    GSDEventTags.h provides type-safe tag constants. GSDEventTags.cpp initializes them. No string literals needed in event code.
  </done>
</task>
...
4. GSDEventTags.cpp exists and initializes all tag constants
</verification>
...
- GSDEventTags.cpp initializes all tag constants via RequestGameplayTag
