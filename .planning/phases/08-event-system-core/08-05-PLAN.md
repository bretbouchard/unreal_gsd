...
<task type="auto">
  ...
  <done>
    Scheduler header exists with FGSDEventInstance struct, GenerateDailySchedule, StartEvent, EndEvent.
  </done>
</task>
...
<task type="auto">
  ...
  <done>
    Scheduler implementation uses GSDDeterminismManager::EventCategory. DateToSeed pattern converts dates to seeds. Same inputs produce same outputs.
  </done>
</task>
